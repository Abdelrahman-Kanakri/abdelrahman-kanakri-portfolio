    ...
    <section id="contact" className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid lg:grid-cols-5 gap-6 sm:gap-8 lg:gap-12">
          <motion.div className="lg:col-span-2 space-y-4 sm:space-y-6" initial={{ x: -30, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
          ...
          <motion.div className="lg:col-span-3" initial={{ x: 30, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
